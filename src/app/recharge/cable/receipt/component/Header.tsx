    ...
    <section className='flex flex-col'>
      <div className='flex items-center justify-between gap-3'>
        ...
        <h2 className='font-Poppins text-sm font-normal text-[#2A2A2A] capitalize sm:text-base md:text-xl'>
          {userNav === "Data" ? 'data subscription' : userNav === "Airtime" ? 'airtime recharge' : userNav === "Electricity" ? "electricity bill" : userNav === "Cable Subscription" ? "cable subscription" : 'Cable Subscription'}
        </h2>
      </div>
