   ...
   const userToken = (Cookies.get("token") as string) || "";
    ...
    const parsedDetails = JSON?.parse(purchasedetails);
     const parsedDetailsnew = JSON?.parse(purchasedetailsnew);
        //   console.log(parsedDetailsnew, 'purchasedetails')

    //  console.log(parsedDetails, 'purchasedetails');
 /*     console.log(parsedDetailsnew, 'purchasedetailsnew') */
        ...
        <div className="space-y-4">
          {[
            ...
            { label: "Phone Number", value: parsedDetails?.data?.phone_number || 'NA' },
             { label: "Operator", value: parsedDetailsnew?.cableTvType || 'NA' },
            { label: "Package", value: parsedDetailsnew?.cableTvType || 'NA'},
             { label: "IUC Number", value: parsedDetailsnew?.customerId || 'NA'},
            { label: "Amount", value:  `₦ ${parsedDetailsnew?.amount || 0}` },
