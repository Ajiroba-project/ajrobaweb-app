...
const DropDownAuctionWin: React.FC<DropdownProps> = ({ onOptionClick, value, transaction }) => {
  ...
  const handleOptionClick = (option: string) => {
    ...
    switch (option) {
      case 'Purchase order':
     transaction?.id ?   router.push(`/raffledrawwins?orderId=${transaction?.id}`) : router.push(`/raffledrawwins?orderId=${transaction?.order_id}`);
        break;
...
export default DropDownAuctionWin;
