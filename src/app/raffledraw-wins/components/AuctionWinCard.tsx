        ...
        <div className="flex flex-col ">
          {auctionLoading ? (
            ...
            currentData?.map((val: any, index: number) => (
              ...
              >
                <div className="relative flex gap-4 border p-3 flex-wrap cursor-pointer"
                  onClick={() =>
                    router.push(`/raffledraw/productdetails/${val?.auction[0]?.auction_id}`)
                  }
                >
                  <div className="relative min-h-[80px] w-[100px] shrink-0 self-stretch overflow-hidden rounded-lg">
                    <Image
