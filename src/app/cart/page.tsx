...
//   const totalPages = Math.ceil(cartItemsn?.length / itemsPerPage);
...
//     setCartItemsn(cartItemsn.filter((item) => item.id !== id));
//   };
...
//             <div
//               className="cursor-pointer container flex justify-start mt-4
//                     "
//             >
...
//                         <h1 className="text-[#b4a3a3] text-sm  mt-4">
//                           Food Stuff . In Stock
//                         </h1>
//                       </div>
...
//                 <h1 className="text-[#2A2A2A] text-base font-Poppins">
//                   Cart SUMMARY
//                 </h1>
...
//                   className="mt-4 px-12 py-2 text-sm bg-[#FCDFD4] hover:bg-[#FCDFD4] text-[#2A2A2A] font-semibold rounded"
//                 >
//                   Check out (N {grandTotal.toLocaleString()})
//                 </button>

//                 <div className="mt-4">
//                   <small className="  text-[#F25E26]">
