  ...
  return (
    <>
      <Suspense>
        ...
        <main className='w-full overflow-x-hidden pt-20 sm:pt-24 md:pt-28 content-container'>
          ...
          <section className='content-visibility-auto my-8 w-full md:my-12 lg:my-16'>
            <div className=''>
