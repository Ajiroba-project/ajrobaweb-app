   ...
   /*       backgroundPosition: "top", */
            ...
            >
              <div className="bg-[#F6F6F6] items-center cursor-pointer p-8">
                ...
                <h1 className='flex text-[#111111] font-semibold text-base font-Poppins justify-center items-center' >Getting Started With Ajiroba</h1>
              ...
              <div className="p-8 flex flex-col gap-5">
                <div>
                  ...
                  <div>
                    <p className="text-sm font-Poppins text-[#2A2A2A] font-normal">
                     To register on Ajiroba Technologies, first, visit our website and click on the &ldquo;Register&ldquo;
                      or &ldquo;Sign Up&ldquo; button. Fill in your details, including your name, email, and password.
                      After submitting your information, you will receive a verification email.
                       Click on the link in the email to verify your account. Once verified,
                        log in to your new account and complete your profile
                      by adding your contact information and preferred payment methods
                    </p>
                  </div>
                  ...
                  <div  className='mt-12'>
                    <p className="text-sm font-Poppins text-[#2A2A2A] font-normal">
                    To buy a product, navigate to the &ldquo;Shop&ldquo; section on our website.
                     Use the search bar or browse through categories to
                      find the product you want to purchase. Click on the product
                       for more details, select the desired quantity, and click &ldquo;Add to Cart.&quot;
                       Once you&lsquo;ve added all your items to the cart, go to your
                    cart and review your selections. Click &ldquo;Checkout,&ldquo; enter your
                    shipping information, and select a payment method. Confirm your
                     order and place it. You will receive an email confirmation
                     with your order details and tracking information once your item is shipped.
                    </p>
                  </div>
               ...
               <button onClick={()=> router.push('/livechat')}
            className=" mt-4 px-12 py-2 text-sm bg-[#FCDFD4] hover:[#FCDFD4] text-[#2A2A2A] font-semibold font-Poppins rounded"
          >
            Chat Now
          </button>
