...
//               <div
//                 key={index}
//                 className="flex flex-col justify-between md:flex-row gap-4 mt-8 items-center border px-8 py-8 rounded-md"
//               >
//                 <div className="flex items-center gap-2  ">
//                   <div className="">
//                     <Image
...
//                   <div className="flex flex-col gap-2 w-64" style={{width: '40rem'}}>
//                     <div>
