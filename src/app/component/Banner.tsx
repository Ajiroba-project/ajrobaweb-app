  ...
  return (
    <div className={`${poppins.className}flex items-center justify-center`}>
      <div className='container flex flex-col items-center justify-between pt-[2rem] md:flex-row lg:flex-row'>
        <div className='flex flex-col items-center justify-center gap-4 py-6 text-white md:items-start md:justify-start md:py-0 lg:w-1/3 lg:items-start lg:justify-start lg:py-0'>
          <h3 className='text-center text-2xl md:text-left lg:text-left'>
