...
const Page = ({ params }: any) => {
                ...
                <div className="flex 2xl:flex-row xl:flex-row lg:flex-row md:flex-row flex-col 2xl:items-start xl:items-start lg:items-start md:items-start items-center gap-12 mt-8">
                    <div className=" w-1/2">
                        <p className="flex mt-4 items-center text-[#111111] text-sm gap-1">
                            ...
                            <span className="ml-4 text-[#2A2A2A] font-Poppins text-[8px] font-normal" > ({data?.data?.product_reviews?.total_reviews}) Reviews</span>
                        </p>
                            ...
                            (
                                ...
                                return (
                                    <div key={index}>
                                        ...
                                        >
                                            <div>
                                                <span className="font-Poppins text-[16px] text-[#353131]">{item.stars} stars</span>
                                            </div>
                                            ...
                                            <div>
                                                <small className="font-Poppins text-[16px] text-[#353131]">{item.customers}</small>
                                            </div>
                                        </div>
                                    </div>
                                );
                                ...
                                return (
                                    <div key={key} className="flex gap-2">
                                        ...
                                        <div className="mb-8 flex-1 ">
                                            ...
                                            <p className="font-Poppins font-normal text-[13px]" >{item.comment}</p>
                                        </div>
                                    </div>
                                );
                            },
    ...
    return (
        ...
        {/*     <ToastContainer /> */}
            ...
            <section className="container py-4  " style={{
                margin: '0 auto',
                width: '80%'
            }}>
                ...
                {productdata?.data?.related_products && (
                     <RelatedProductsDetails cardInfo={productdata?.data?.related_products}  />
                )}
